...
class RobotBuilder{
   ...
   */
  RobotBuilder &withMotors(const Motor &ileft, const Motor &iright);
   ...
   * @return An ongoing builder.
   */
  RobotBuilder &withMotors(const MotorGroup &ileft, const MotorGroup &iright);
   ...
   * @return An ongoing builder.
   */
  RobotBuilder &withMotors(const Motor &itopLeft,
   ...
   * @return An ongoing builder.
   */
  RobotBuilder &withMotors(const MotorGroup &itopLeft,
   ...
   * @return An ongoing builder.
   */
  RobotBuilder &withSensors(const ADIEncoder &ileft, const ADIEncoder &iright);
   ...
   * @return An ongoing builder.
   */
  RobotBuilder &withSensors(const IntegratedEncoder &ileft,
   ...
   * @return An ongoing builder.
   */
  RobotBuilder &withOdometry(const StateMode &imode = StateMode::FRAME_TRANSFORMATION,
   ...
   * @return An ongoing builder.
   */
  RobotBuilder &withDerivativeFilters(
   ...
   * @return An ongoing builder.
   */
  RobotBuilder &withDimensions(const ChassisScales &iscales);
   ...
   * @return An ongoing builder.
   */
  RobotBuilder &withMaxVelocity(double imaxVelocity);
   ...
   * @return An ongoing builder.
   */
  RobotBuilder &withMaxVoltage(double imaxVoltage);
  ...
  /**
   * Builds the DriveController. Throws a std::runtime_exception if no motors were set.
   *
   * @return A fully built DriveController.
   */
  std::shared_ptr<DriveController> build();

  /**
   * Builds the DriveController. Throws a std::runtime_exception if no motors were set or if
   * no odometry information was passed.
   *
   * @return A fully built DriveController.
   */
  std::shared_ptr<DriveController> buildOdometry();
  ...
  std::shared_ptr<ChassisController> buildController();
